            ...
            <div>
                <div class="panel-body">
                            ...
                            <div class="row order-list-item">
                                <a href="<?=Url::to(['user/order-info','order_code'=>$vo['order_code']])?>">
                                ...
                                <div class="col-xs-12 order-total">
                                    ...
                                    <div class="col-xs-6">共计：¥<?=$vo['amount']?></div>
                                </div>

                                <div class="col-xs-12 order-f-but">
                                    <div class="col-xs-4"><a href=""><img src="/public/uploads/user_pic.png" alt="">赵某某</a></div>
                                    <div class="col-xs-8 order-bth">
                                        <a href="">联系负责人</a>
                                        <?php if($vo['pay_status'] != 1): ?>
                                        <a href="<?=Url::to(['goods/buy-goods','order_code'=>$vo['order_code']])?>">去支付</a>
                                        <?php endif; ?>
                                        <?php if($vo['is_evaluate'] == 0 && $vo['status'] == 3): ?>
                                            <a href="<?=Url::to(['user/order-evaluation','order_code'=>$vo['order_code']])?>">待评价</a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
