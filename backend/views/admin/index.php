            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                        ...
                        <div class="col-sm-4">
                            <?php $form = ActiveForm::begin() ?>
                                <div class="input-group">
                                    <input type="text" name="keywords" placeholder="请输入用户名、UID、手机、邮箱等关键词..." class="input-sm form-control">
                    ...
                    <table class="table table-hover table-list">
                        ...
                        <tr>
                            <td><?=$td['id']?></td>
                            <td><img src="<?=Url::to($td['avatar'])?>" alt="" width="40px" height="40px;"></td>
                            <td><?=Html::encode($td['username']) ?></td>
                            <td><?=Html::encode($td['nickname']) ?></td>
                            <td><?=$td['phone'] ?></td>
                            <td><?=$td['email'] ?></td>
