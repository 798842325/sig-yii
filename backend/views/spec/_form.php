...
/* @var $Spec common\models\AuthItem */
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <?=$form->field($Spec,'spec_name')->textInput(['class'=>'form-control'])->label('规格名称：',['class'=>'col-sm-2  control-label'])?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="col-sm-4 m-l-n">
                                    <select class="form-control"   name="<?=$Spec ->formName()?>[goods_type_id]">
                                        <?php foreach ($GoodsType as $v): ?>
                                            <option value="<?=$v['id']?>" <?=$Spec->goods_type_id==$v['id']?'selected':'' ?> ><?=$v['name']?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <?=$form->field($Spec,'entry_way')->radioList(['1'=>'手动录入','2'=>'下面下拉选项录入','3'=>'手动和下拉选项录入'])->label('录入方式：',['class'=>'col-sm-2  control-label'])?>

                        <?=$form->field($Spec,'spec_value')->textarea(['class'=>'form-control','cols'=>"20",'rows'=>"6"])->label('规格项：',['class'=>'col-sm-2  control-label'])?>


                        <?=$form->field($Spec,'sort')->textInput(['value'=>'0','class'=>'form-control'])->label('排序：',['class'=>'col-sm-2  control-label'])?>
