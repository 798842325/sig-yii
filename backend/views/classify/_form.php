            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="col-sm-4 m-l-n">
                                    <select class="form-control" multiple=""  name="<?=$model ->formName()?>[pid]">
                                        <option value="0" <?=$model->pid?:'selected' ?>>/</option>
                                        <?php foreach ($d_classify as $v): ?>
                                            <option value="<?=$v['id']?>" <?=$model->pid==$v['id']?'selected':'' ?>><?=$v['title']?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">分类平台:</label>

                            <div class="col-sm-10">
                                <div class="col-sm-4 m-l-n">
                                    <select class="form-control" multiple=""  name="<?=$model ->formName()?>[cate_id]">
                                        <?php foreach ($d_classifyType as $v): ?>
                                            <option value="<?=$v['id']?>" <?=$model->cate_id==$v['id']?'selected':'' ?>><?=$v['title']?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
