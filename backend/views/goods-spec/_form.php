...
/* @var $GoodsSpec common\models\AuthItem */
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <?=$form->field($GoodsSpec,'name')->textInput(['class'=>'form-control'])->label('规格名称：',['class'=>'col-sm-2  control-label'])?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="col-sm-4 m-l-n">
                                    <select class="form-control" multiple=""  name="<?=$GoodsSpec ->formName()?>[goods_type]">
                                        <?php foreach ($GoodsType as $v): ?>
                                            <option value="<?=$v['id']?>" <?=$GoodsSpec->goods_type==$v['id']?'selected':'' ?>><?=$v['name']?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="col-sm-4 m-l-n">
                                    <textarea name="spec_value" id="" cols="20" rows="6" class="form-control"><?php foreach ($SpecValue as $k=>$v):?><?=$v['item']?>
...
<?php endforeach; ?></textarea>
                        ...
                        <?=$form->field($GoodsSpec,'sort')->textInput(['value'=>'0','class'=>'form-control'])->label('排序：',['class'=>'col-sm-2  control-label'])?>
