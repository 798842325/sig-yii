            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <?=$form->field($model,'title')->textInput(['class'=>'form-control'])->label('角色名称：',['class'=>'col-sm-2  control-label'])?>

                        <?=$form->field($model,'description')->textarea(['class'=>'form-control'])->label('描述：',['class'=>'col-sm-2  control-label'])?>
                        ...
                        <div class="form-group field-authgroup-title">
                            ...
                            <div class="col-sm-10">
                                <div class="row">
                                    ...
                                    <div class="col-xs-5">
                                        <select name="rules[]" id="search_to" class="form-control" size="8" multiple="multiple">
                                            <?php  foreach ($to_rule as $v): ?>
                                                <option value="<?=$v['id']?>"><?=$v['title']?></option>
                                            <?php  endforeach; ?>
                                        </select>
                                    </div>
