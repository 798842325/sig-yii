            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><?= Html::a('缓存分类', ['cache-classify'])?></li>
                ...
                <div class="ibox-content">
                    ...
                    <table class="table table-hover table-list">
                        ...
                        <tr>
                            <td><?=$td['order_code'] ?></td>
                            <td><?=$td['goods_title']?></td>
                            <td><?=date('Y.m.d h:i:s',$td['cretad_at'])?></td>
                            <td><?=$td['receiver']?></td>
                            <td><?=$td['receiving_phone']?></td>
                            <td>&yen;<?=$td['amount']?></td>
                            <td><?=$td['receiving_phone']?></td>
                            <td>
                                <?=$td['status']?Html::a('禁用',['state','id'=>$td['order_code'],'status'=>0],['class'=>'ajax-get']):Html::a('启用',['state','id'=>$td['order_code'],'status'=>1],['class'=>'ajax-get'])?>
                                <?=$td['status']?Html::a('禁用',['state','id'=>$td['order_code'],'status'=>0],['class'=>'ajax-get']):Html::a('启用',['state','id'=>$td['order_code'],'status'=>1],['class'=>'ajax-get'])?>
                            </td>
                            <td class="text-navy">
                                <?= Html::a('编辑', ['update','id'=>$td['order_code']]) ?>
                                <?= Html::a('删除', ['delete','id'=>$td['order_code']],['class'=>'ajax-del','ajax-form-method'=>'POST']) ?>
                            </td>
                        </tr>
                        <?php endforeach ?>
                        </tbody>
