        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <?= $form->field($model, 'title')->textInput(['class' => 'form-control'])->label('服务名称:', ['class' => 'col-sm-2  control-label']) ?>

                    <?= $form->field($model, 'describe')->textarea(['class' => 'form-control'])->label('服务描述:', ['class' => 'col-sm-2  control-label']) ?>

                    <?= $form->field($model, 'service_price')->textInput(['class' => 'form-control'])->label('服务价格:', ['class' => 'col-sm-2  control-label']) ?>


                    <div class="form-group">
                        <label class="col-sm-2 control-label">服务图: </label>
                        <div class="col-sm-10">
                            <div id="upload-img-one">
                                <img src="<?= Url::to($model->cover ?: '/public/uploads/add_default.png') ?>"
                                     alt="">
                                <div class="upload-img-btn">
                                    <div id="filePicker">选择图片</div>
                                </div>
                                <input type="hidden" name="<?= $model->formName() ?>[cover]"
                                       value="<?= $model->cover ?>">
                            </div>
                        </div>
                    </div>

                    <?= $form->field($model, 'content')->textarea(['class' => 'form-control', 'id' => 'content', 'style' => 'height:400px;'])->label('服务详情：', ['class' => 'col-sm-2  control-label']) ?>
